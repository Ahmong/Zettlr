 ...
 */
export function getBlockMathRE () {
  return RegExp(
    /^(\s*\$\$)\s*$/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getCodeBlockRE (multiline = false) {
  if (!multiline) {
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getFnExportRE (multiline = false) {
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getFnReferenceRE () {
  return RegExp(
    /^\[\^.+\]:\s/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getFnRefRE (multiline = false) {
  let flag = (multiline) ? 'm' : ''
  return RegExp(
    /^\[\^([\da-zA-Z_-]+)\]: (.+)/.source,
    'g' + flag)
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getFootnoteRefRE () {
  return RegExp(
    /\[\^[^\]]+\]/.source,
    'i')
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getHighlightRE () {
  return RegExp(
    /::.+?::|==.+?==/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getIDRE (multiline = false) {
  let flag = (multiline) ? 'm' : ''
 ...
 */
export function getImageRE (multiline = false) {
  let flag = (multiline) ? 'm' : ''
  return RegExp(
    /(?<=\s|^)!\[(.*?)\]\((.+?(?:(?<= )"(.+)")?)\)({[^{]+})?/.source,
    // Necessary flags + optional multiline flag
 ...
 */
export function getImageFileRE (multiline = false) {
  let flag = (multiline) ? 'm' : ''
  return RegExp(
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getInlineMathRE (global = false) {
  let flag = (global) ? 'g' : ''
  return RegExp(
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getInlineMathRenderRE (global = false) {
  let flag = (global) ? 'g' : ''
  return RegExp(
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getListEmptyRE () {
  return RegExp(
    /^(\s*)([*+-] \[[x ]\]|[*+-]|(\d+)[.)])(\s*)$/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getListOrderedRE () {
  return RegExp(
    /^(\s*)((\d+)([.)]))(\s*)/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getListTaskListRE () {
  return RegExp(
    /^(\s*)(- \[[x ]\])(\s*)/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getListTokenRE () {
  return RegExp(
    /^(\s*)(>[> ]*|[*+-] \[[x ]\]|[*+-]|(\d+)[.)])(\s*)/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getListUnorderedRE () {
  return RegExp(
    /[*+-]\s/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getListUnorderedCMRE () {
  return RegExp(
    /^(\s*)([*+-])\s/.source
  )
};
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getMarkDownFileRE () {
  return RegExp(
 ...
 * @return  {RegExp}           The wanted regular expression
 */
export function getProtocolRE (multiline = false) {
  let flag = (multiline) ? 'm' : ''
  return RegExp(
    /^([a-z]{1,10}):\/\//,
    'i' + flag
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getTableHeadingRE () {
return RegExp(
    /(^[- ]+$)|(^[- +:]+$)|(^[- |:+]+$)/.source
  )
};
 ...
 * @return  {RegExp}                   The compiled Regular Expression
 */
export function getZknTagRE (global = false) {
  return RegExp(
    /(?<=^|\s|[({[])#(#?[^\s,.:;…!?"'`»«“”‘’—–@$%&*#^+~÷\\/|<=>[\](){}]+#?)/.source,
    (global) ? 'gi' : 'i')
}
